...
---
    ...
    Output
      ...
      extern int write__make_testpkg_wrappers(const char *package_name, const char *out_path);
      ...
      int main(int argc, char **argv) {
          ...
          return write__make_testpkg_wrappers(argv[1], argv[2]);
      }
