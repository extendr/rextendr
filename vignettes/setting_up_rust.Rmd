...
`R_HOME` should point to R folder, e.g. `C:\Program Files\R\R-4.1.0` (be careful with spaces in the path).
`RTOOLS40_HOME` should point to Rtools folder (usually set up automatically by the installer), which is `C:\rtools40` by default.
