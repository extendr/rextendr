...
- The `libgcc_eh` mock in the `Makevars.win.in` template moved from the
  cargo target directory to the temporary `.cargo` directory.
  Pre-creating the target directory kept cargo from writing its
  `CACHEDIR.TAG` marker there, and recent cargo versions refuse to
  `cargo clean` an untagged directory, which broke
  [`rextendr::clean()`](https://extendr.github.io/rextendr/reference/clean.md)
  on Windows.
- The `Makevars.in` / `Makevars.win.in` templates installed by
  [`use_extendr()`](https://extendr.github.io/rextendr/reference/use_extendr.md)
  now pass identical `RUSTFLAGS`, `@PANIC_EXPORTS@` (Unix), and
  `@PROFILE@` to both the `cargo build --lib` and
  `cargo run --bin document` invocations. Previously the second
  invocation ran with neither, which gave it a different fingerprint and
  caused `cargo` to rebuild every dependency from scratch on package
  install.
  ([extendr/extendr#1087](https://github.com/extendr/extendr/issues/1087))
- Moved from document.rs to document.c to avoid inflating package SHLIB
  size with linked dead code.
  ([extendr/rextendr#529](https://github.com/extendr/rextendr/pull/529))
  See also
  [extendr/extendr#1101](https://github.com/extendr/extendr/pull/1101)
  and
...
- Refactor of
  ...
  and
  [`rust_function()`](https://extendr.github.io/rextendr/reference/rust_source.md)
  ...
  - Unknown macro options in dev and release now throw errors instead of
    warnings
- [`vendor_pkgs()`](https://extendr.github.io/rextendr/reference/vendor_crates.md)
...
- Added
  [`update_scaffold()`](https://extendr.github.io/rextendr/reference/update_scaffold.md)
...
- [`write_license_note()`](https://extendr.github.io/rextendr/reference/write_license_note.md)
...
- [`vendor_pkgs()`](https://extendr.github.io/rextendr/reference/vendor_crates.md)
  has been renamed to
  [`vendor_crates()`](https://extendr.github.io/rextendr/reference/vendor_crates.md)
...
- Complete overhaul of wrapper-generation.
  ...
  - [`rextendr::document()`](https://extendr.github.io/rextendr/reference/document.md)
  ...
  - [`register_extendr()`](https://extendr.github.io/rextendr/reference/register_extendr.md)
...
- Added
  [`use_vscode()`](https://extendr.github.io/rextendr/reference/use_vscode.md)
  and its alias
  [`use_positron()`](https://extendr.github.io/rextendr/reference/use_vscode.md)
...
- [`use_extendr_badge()`](https://extendr.github.io/rextendr/reference/use_extendr_badge.md)
...
- [`rust_sitrep()`](https://extendr.github.io/rextendr/reference/rust_sitrep.md)
...
- Added
  [`use_crate()`](https://extendr.github.io/rextendr/reference/use_crate.md)
...
- Added
  [`use_msrv()`](https://extendr.github.io/rextendr/reference/use_msrv.md)
  to aid in specifying the minimum supported rust version (MSRV) for an
  R package
- Added
  [`read_cargo_metadata()`](https://extendr.github.io/rextendr/reference/read_cargo_metadata.md)
...
- Developer note: new helper function
  [`local_quiet_cli()`](https://extendr.github.io/rextendr/reference/local_quiet_cli.md)
...
- A `<pkg_name>-win.def` file containing DLL exports is created by
  [`rextendr::use_extendr()`](https://extendr.github.io/rextendr/reference/use_extendr.md).
